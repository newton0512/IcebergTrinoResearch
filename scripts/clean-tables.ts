import { HybridDataGeneratorV4 } from "../src/generator/index.js";
import type { HybridGeneratorConfigV4 } from "../src/generator/index.js";
      ...
      try {
        ...
        if (cleanV4) {
          ...
          if (shouldDrop) {
            ...
            console.log("✓ PostgreSQL check tables dropped (V4)");
          } else {
            // TRUNCATE не поддерживает IF EXISTS, проверяем существование через DO блок
            await sql.unsafe(`
              DO $$
              ...
              END $$;
            `);
            console.log("✓ PostgreSQL check tables truncated (V4)");
          }
